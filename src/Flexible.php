...
use Glacom\NovaFlexibleContent\Layouts\Collection as LayoutsCollection;
use Glacom\NovaFlexibleContent\Layouts\Layout;
use Glacom\NovaFlexibleContent\Layouts\LayoutInterface;
use Glacom\NovaFlexibleContent\Layouts\Preset;
use Glacom\NovaFlexibleContent\Value\Resolver;
use Glacom\NovaFlexibleContent\Value\ResolverInterface;
...
class Flexible extends Field
{
     ...
     *
     * @var \Glacom\NovaFlexibleContent\Layouts\Collection
     */
    protected $layouts;
     ...
     *
     * @var \Glacom\NovaFlexibleContent\Value\ResolverInterface
     */
    protected $resolver;
     ...
     *
     * @param  \Glacom\NovaFlexibleContent\Layouts\LayoutInterface  $layout
     * @return void
     */
     ...
     *
     * @param  string  $key
     * @return \Glacom\NovaFlexibleContent\Layouts\Layout
     */
     ...
     * @param  string  $layout
     * @param  string  $key
     * @return null|\Glacom\NovaFlexibleContent\Layouts\Layout
     */
     ...
     *
     * @param  string  $key
     * @return null|\Glacom\NovaFlexibleContent\Http\FlexibleAttribute
     */
    ...
    protected function registerOriginModel($model)
    {
        if (is_a($model, \Laravel\Nova\Resource::class)) {
            $model = $model->model();
        } elseif (is_a($model, \Glacom\NovaPage\Pages\Template::class)) {
